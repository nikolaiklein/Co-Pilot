...
from services.prompt_builder import build_system_prompt  # noqa: E402
...
# Импорт модельных данных из единого источника
from services.model_data import NVIDIA_MODELS, GEMINI_MODELS, DEFAULT_MODELS
